...
func newPermission(db *gorm.DB, opts ...gen.DOOption) permission {
	...
	_permission.RolePermissions = permissionHasManyRolePermissions{
		...
		Role: struct {
			...
			RelationField: field.NewRelation("RolePermissions.Role", "models.Role"),
			UserRoles: struct {
				field.RelationField
				User struct {
					field.RelationField
				...
				RelationField: field.NewRelation("RolePermissions.Role.UserRoles", "models.UserRole"),
				User: struct {
					field.RelationField
					UserOAuthProviders struct {
						field.RelationField
					...
					RelationField: field.NewRelation("RolePermissions.Role.UserRoles.User", "models.User"),
					UserOAuthProviders: struct {
						field.RelationField
						User struct {
							field.RelationField
						...
						RelationField: field.NewRelation("RolePermissions.Role.UserRoles.User.UserOAuthProviders", "models.UserOAuthProvider"),
						User: struct {
							field.RelationField
						}{
							RelationField: field.NewRelation("RolePermissions.Role.UserRoles.User.UserOAuthProviders.User", "models.User"),
						},
						Provider: struct {
							field.RelationField
							UserOAuthProviders struct {
							...
							RelationField: field.NewRelation("RolePermissions.Role.UserRoles.User.UserOAuthProviders.Provider", "models.OAuthProvider"),
							UserOAuthProviders: struct {
								field.RelationField
							}{
								RelationField: field.NewRelation("RolePermissions.Role.UserRoles.User.UserOAuthProviders.Provider.UserOAuthProviders", "models.UserOAuthProvider"),
							},
						},
					},
					UserRoles: struct {
						...
						RelationField: field.NewRelation("RolePermissions.Role.UserRoles.User.UserRoles", "models.UserRole"),
					},
				},
				Role: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("RolePermissions.Role.UserRoles.Role", "models.Role"),
				},
			},
			RolePermissions: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("RolePermissions.Role.RolePermissions", "models.RolePermission"),
			},
		},
		Permission: struct {
			field.RelationField
			...
			RelationField: field.NewRelation("RolePermissions.Permission", "models.Permission"),
			RolePermissions: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("RolePermissions.Permission.RolePermissions", "models.RolePermission"),
			},
		},
	}
...
type permission struct {
	...
	RolePermissions permissionHasManyRolePermissions
...
func (p permission) clone(db *gorm.DB) permission {
	...
	p.RolePermissions.db = db.Session(&gorm.Session{Initialized: true})
	p.RolePermissions.db.Statement.ConnPool = db.Statement.ConnPool
	return p
}

func (p permission) replaceDB(db *gorm.DB) permission {
	p.permissionDo.ReplaceDB(db)
	p.RolePermissions.db = db.Session(&gorm.Session{})
	return p
}

type permissionHasManyRolePermissions struct {
	db *gorm.DB
...
func (a permissionHasManyRolePermissions) Where(conds ...field.Expr) *permissionHasManyRolePermissions {
	if len(conds) == 0 {
		return &a
	}
...
func (a permissionHasManyRolePermissions) WithContext(ctx context.Context) *permissionHasManyRolePermissions {
	a.db = a.db.WithContext(ctx)
	return &a
}

func (a permissionHasManyRolePermissions) Session(session *gorm.Session) *permissionHasManyRolePermissions {
	a.db = a.db.Session(session)
	return &a
}

func (a permissionHasManyRolePermissions) Model(m *models.Permission) *permissionHasManyRolePermissionsTx {
	return &permissionHasManyRolePermissionsTx{a.db.Model(m).Association(a.Name())}
}

func (a permissionHasManyRolePermissions) Unscoped() *permissionHasManyRolePermissions {
	a.db = a.db.Unscoped()
	return &a
}

type permissionHasManyRolePermissionsTx struct{ tx *gorm.Association }

func (a permissionHasManyRolePermissionsTx) Find() (result []*models.RolePermission, err error) {
	return result, a.tx.Find(&result)
}

func (a permissionHasManyRolePermissionsTx) Append(values ...*models.RolePermission) (err error) {
...
func (a permissionHasManyRolePermissionsTx) Replace(values ...*models.RolePermission) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a permissionHasManyRolePermissionsTx) Delete(values ...*models.RolePermission) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a permissionHasManyRolePermissionsTx) Clear() error {
	return a.tx.Clear()
}

func (a permissionHasManyRolePermissionsTx) Count() int64 {
	return a.tx.Count()
}

func (a permissionHasManyRolePermissionsTx) Unscoped() *permissionHasManyRolePermissionsTx {
	a.tx = a.tx.Unscoped()
	return &a
}
