...
func newRolePermission(db *gorm.DB, opts ...gen.DOOption) rolePermission {
	...
	_rolePermission.Role = rolePermissionHasOneRole{
		...
		UserRoles: struct {
			...
			RelationField: field.NewRelation("Role.UserRoles", "models.UserRole"),
			User: struct {
				field.RelationField
				UserOAuthProviders struct {
					field.RelationField
				...
				RelationField: field.NewRelation("Role.UserRoles.User", "models.User"),
				UserOAuthProviders: struct {
					field.RelationField
					User struct {
						field.RelationField
					...
					RelationField: field.NewRelation("Role.UserRoles.User.UserOAuthProviders", "models.UserOAuthProvider"),
					User: struct {
						field.RelationField
					}{
						RelationField: field.NewRelation("Role.UserRoles.User.UserOAuthProviders.User", "models.User"),
					},
					Provider: struct {
						field.RelationField
						UserOAuthProviders struct {
						...
						RelationField: field.NewRelation("Role.UserRoles.User.UserOAuthProviders.Provider", "models.OAuthProvider"),
						UserOAuthProviders: struct {
							field.RelationField
						}{
							RelationField: field.NewRelation("Role.UserRoles.User.UserOAuthProviders.Provider.UserOAuthProviders", "models.UserOAuthProvider"),
						},
					},
				},
				UserRoles: struct {
					...
					RelationField: field.NewRelation("Role.UserRoles.User.UserRoles", "models.UserRole"),
				},
			},
			Role: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("Role.UserRoles.Role", "models.Role"),
			},
		},
		RolePermissions: struct {
			...
			RelationField: field.NewRelation("Role.RolePermissions", "models.RolePermission"),
			Role: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("Role.RolePermissions.Role", "models.Role"),
			},
			Permission: struct {
				field.RelationField
				RolePermissions struct {
				...
				RelationField: field.NewRelation("Role.RolePermissions.Permission", "models.Permission"),
				RolePermissions: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("Role.RolePermissions.Permission.RolePermissions", "models.RolePermission"),
				},
			},
		},
	}

	_rolePermission.Permission = rolePermissionHasOnePermission{
		db: db.Session(&gorm.Session{}),
...
type rolePermission struct {
	...
	Role             rolePermissionHasOneRole

	Permission rolePermissionHasOnePermission
...
func (r rolePermission) clone(db *gorm.DB) rolePermission {
	...
	r.Permission.db = db.Session(&gorm.Session{Initialized: true})
	r.Permission.db.Statement.ConnPool = db.Statement.ConnPool
	return r
}
...
func (r rolePermission) replaceDB(db *gorm.DB) rolePermission {
	...
	r.Permission.db = db.Session(&gorm.Session{})
	return r
}

type rolePermissionHasOneRole struct {
	db *gorm.DB
...
func (a rolePermissionHasOneRole) Where(conds ...field.Expr) *rolePermissionHasOneRole {
	if len(conds) == 0 {
		return &a
	}
...
func (a rolePermissionHasOneRole) WithContext(ctx context.Context) *rolePermissionHasOneRole {
	a.db = a.db.WithContext(ctx)
	return &a
}

func (a rolePermissionHasOneRole) Session(session *gorm.Session) *rolePermissionHasOneRole {
	a.db = a.db.Session(session)
	return &a
}

func (a rolePermissionHasOneRole) Model(m *models.RolePermission) *rolePermissionHasOneRoleTx {
	return &rolePermissionHasOneRoleTx{a.db.Model(m).Association(a.Name())}
}

func (a rolePermissionHasOneRole) Unscoped() *rolePermissionHasOneRole {
	a.db = a.db.Unscoped()
	return &a
}

type rolePermissionHasOneRoleTx struct{ tx *gorm.Association }

func (a rolePermissionHasOneRoleTx) Find() (result *models.Role, err error) {
	return result, a.tx.Find(&result)
}

func (a rolePermissionHasOneRoleTx) Append(values ...*models.Role) (err error) {
...
func (a rolePermissionHasOneRoleTx) Replace(values ...*models.Role) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a rolePermissionHasOneRoleTx) Delete(values ...*models.Role) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a rolePermissionHasOneRoleTx) Clear() error {
	return a.tx.Clear()
}

func (a rolePermissionHasOneRoleTx) Count() int64 {
	return a.tx.Count()
}

func (a rolePermissionHasOneRoleTx) Unscoped() *rolePermissionHasOneRoleTx {
	a.tx = a.tx.Unscoped()
	return &a
}

type rolePermissionHasOnePermission struct {
	db *gorm.DB

	field.RelationField
}

func (a rolePermissionHasOnePermission) Where(conds ...field.Expr) *rolePermissionHasOnePermission {
	if len(conds) == 0 {
		return &a
	}
...
func (a rolePermissionHasOnePermission) WithContext(ctx context.Context) *rolePermissionHasOnePermission {
	a.db = a.db.WithContext(ctx)
	return &a
}

func (a rolePermissionHasOnePermission) Session(session *gorm.Session) *rolePermissionHasOnePermission {
	a.db = a.db.Session(session)
	return &a
}

func (a rolePermissionHasOnePermission) Model(m *models.RolePermission) *rolePermissionHasOnePermissionTx {
	return &rolePermissionHasOnePermissionTx{a.db.Model(m).Association(a.Name())}
}

func (a rolePermissionHasOnePermission) Unscoped() *rolePermissionHasOnePermission {
	a.db = a.db.Unscoped()
	return &a
}

type rolePermissionHasOnePermissionTx struct{ tx *gorm.Association }

func (a rolePermissionHasOnePermissionTx) Find() (result *models.Permission, err error) {
	return result, a.tx.Find(&result)
}

func (a rolePermissionHasOnePermissionTx) Append(values ...*models.Permission) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a rolePermissionHasOnePermissionTx) Replace(values ...*models.Permission) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a rolePermissionHasOnePermissionTx) Delete(values ...*models.Permission) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a rolePermissionHasOnePermissionTx) Clear() error {
	return a.tx.Clear()
}

func (a rolePermissionHasOnePermissionTx) Count() int64 {
	return a.tx.Count()
}

func (a rolePermissionHasOnePermissionTx) Unscoped() *rolePermissionHasOnePermissionTx {
	a.tx = a.tx.Unscoped()
	return &a
}
