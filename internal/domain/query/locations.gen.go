...
func newLocation(db *gorm.DB, opts ...gen.DOOption) location {
	...
	_location.Longitude = field.NewString(tableName, "longitude")
	_location.Latitude = field.NewString(tableName, "latitude")
	_location.KelID = field.NewInt64(tableName, "kel_id")
	_location.Kelurahan = locationHasOneKelurahan{
		...
		Kecamatan: struct {
			...
			RelationField: field.NewRelation("Kelurahan.Kecamatan", "models.Kecamatan"),
			Kabupaten: struct {
				field.RelationField
				Province struct {
					field.RelationField
				...
				RelationField: field.NewRelation("Kelurahan.Kecamatan.Kabupaten", "models.Kabupaten"),
				Province: struct {
					field.RelationField
					Kabupaten struct {
						field.RelationField
					...
					RelationField: field.NewRelation("Kelurahan.Kecamatan.Kabupaten.Province", "models.Province"),
					Kabupaten: struct {
						field.RelationField
					}{
						RelationField: field.NewRelation("Kelurahan.Kecamatan.Kabupaten.Province.Kabupaten", "models.Kabupaten"),
					},
				},
				Kecamatan: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("Kelurahan.Kecamatan.Kabupaten.Kecamatan", "models.Kecamatan"),
				},
			},
			Kelurahan: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("Kelurahan.Kecamatan.Kelurahan", "models.Kelurahan"),
			},
		},
		Locations: struct {
			field.RelationField
			...
			RelationField: field.NewRelation("Kelurahan.Locations", "models.Location"),
			Kelurahan: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("Kelurahan.Locations.Kelurahan", "models.Kelurahan"),
			},
		},
	}
...
type location struct {
	...
	KelID         field.Int64
	Kelurahan     locationHasOneKelurahan
...
func (l *location) updateTableName(table string) *location {
	...
	l.Longitude = field.NewString(table, "longitude")
	l.Latitude = field.NewString(table, "latitude")
...
func (l location) clone(db *gorm.DB) location {
	...
	l.Kelurahan.db = db.Session(&gorm.Session{Initialized: true})
	l.Kelurahan.db.Statement.ConnPool = db.Statement.ConnPool
	return l
}

func (l location) replaceDB(db *gorm.DB) location {
	l.locationDo.ReplaceDB(db)
	l.Kelurahan.db = db.Session(&gorm.Session{})
	return l
}

type locationHasOneKelurahan struct {
	db *gorm.DB
...
func (a locationHasOneKelurahan) Where(conds ...field.Expr) *locationHasOneKelurahan {
	if len(conds) == 0 {
		return &a
	}
...
func (a locationHasOneKelurahan) WithContext(ctx context.Context) *locationHasOneKelurahan {
	a.db = a.db.WithContext(ctx)
	return &a
}

func (a locationHasOneKelurahan) Session(session *gorm.Session) *locationHasOneKelurahan {
	a.db = a.db.Session(session)
	return &a
}

func (a locationHasOneKelurahan) Model(m *models.Location) *locationHasOneKelurahanTx {
	return &locationHasOneKelurahanTx{a.db.Model(m).Association(a.Name())}
}

func (a locationHasOneKelurahan) Unscoped() *locationHasOneKelurahan {
	a.db = a.db.Unscoped()
	return &a
}

type locationHasOneKelurahanTx struct{ tx *gorm.Association }

func (a locationHasOneKelurahanTx) Find() (result *models.Kelurahan, err error) {
	return result, a.tx.Find(&result)
}

func (a locationHasOneKelurahanTx) Append(values ...*models.Kelurahan) (err error) {
...
func (a locationHasOneKelurahanTx) Replace(values ...*models.Kelurahan) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a locationHasOneKelurahanTx) Delete(values ...*models.Kelurahan) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a locationHasOneKelurahanTx) Clear() error {
	return a.tx.Clear()
}

func (a locationHasOneKelurahanTx) Count() int64 {
	return a.tx.Count()
}

func (a locationHasOneKelurahanTx) Unscoped() *locationHasOneKelurahanTx {
	a.tx = a.tx.Unscoped()
	return &a
}
