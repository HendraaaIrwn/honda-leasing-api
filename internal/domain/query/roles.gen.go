...
func newRole(db *gorm.DB, opts ...gen.DOOption) role {
	...
	_role.UserRoles = roleHasManyUserRoles{
		...
		User: struct {
			...
			RelationField: field.NewRelation("UserRoles.User", "models.User"),
			UserOAuthProviders: struct {
				field.RelationField
				User struct {
					field.RelationField
				...
				RelationField: field.NewRelation("UserRoles.User.UserOAuthProviders", "models.UserOAuthProvider"),
				User: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("UserRoles.User.UserOAuthProviders.User", "models.User"),
				},
				Provider: struct {
					field.RelationField
					UserOAuthProviders struct {
					...
					RelationField: field.NewRelation("UserRoles.User.UserOAuthProviders.Provider", "models.OAuthProvider"),
					UserOAuthProviders: struct {
						field.RelationField
					}{
						RelationField: field.NewRelation("UserRoles.User.UserOAuthProviders.Provider.UserOAuthProviders", "models.UserOAuthProvider"),
					},
				},
			},
			UserRoles: struct {
				...
				RelationField: field.NewRelation("UserRoles.User.UserRoles", "models.UserRole"),
			},
		},
		Role: struct {
			field.RelationField
			...
			RelationField: field.NewRelation("UserRoles.Role", "models.Role"),
			UserRoles: struct {
				field.RelationField
			}{
				RelationField: field.NewRelation("UserRoles.Role.UserRoles", "models.UserRole"),
			},
			RolePermissions: struct {
				field.RelationField
				Role struct {
				...
				RelationField: field.NewRelation("UserRoles.Role.RolePermissions", "models.RolePermission"),
				Role: struct {
					field.RelationField
				}{
					RelationField: field.NewRelation("UserRoles.Role.RolePermissions.Role", "models.Role"),
				},
				Permission: struct {
					field.RelationField
					RolePermissions struct {
					...
					RelationField: field.NewRelation("UserRoles.Role.RolePermissions.Permission", "models.Permission"),
					RolePermissions: struct {
						field.RelationField
					}{
						RelationField: field.NewRelation("UserRoles.Role.RolePermissions.Permission.RolePermissions", "models.RolePermission"),
					},
				},
			},
		},
	...
	_role.RolePermissions = roleHasManyRolePermissions{
		db: db.Session(&gorm.Session{}),

		RelationField: field.NewRelation("RolePermissions", "models.RolePermission"),
	}
...
type role struct {
	...
	RolePermissions roleHasManyRolePermissions
...
func (r role) clone(db *gorm.DB) role {
	...
	r.RolePermissions.db = db.Session(&gorm.Session{Initialized: true})
	r.RolePermissions.db.Statement.ConnPool = db.Statement.ConnPool
	return r
}
...
func (r role) replaceDB(db *gorm.DB) role {
	...
	r.RolePermissions.db = db.Session(&gorm.Session{})
	return r
}
...
func (a roleHasManyUserRoles) Model(m *models.Role) *roleHasManyUserRolesTx {
...
func (a roleHasManyUserRolesTx) Find() (result []*models.UserRole, err error) {
	return result, a.tx.Find(&result)
}

func (a roleHasManyUserRolesTx) Append(values ...*models.UserRole) (err error) {
...
func (a roleHasManyUserRolesTx) Replace(values ...*models.UserRole) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a roleHasManyUserRolesTx) Delete(values ...*models.UserRole) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
type roleHasManyRolePermissions struct {
	db *gorm.DB

	field.RelationField
}

func (a roleHasManyRolePermissions) Where(conds ...field.Expr) *roleHasManyRolePermissions {
	if len(conds) == 0 {
		return &a
	}
...
func (a roleHasManyRolePermissions) WithContext(ctx context.Context) *roleHasManyRolePermissions {
	a.db = a.db.WithContext(ctx)
	return &a
}

func (a roleHasManyRolePermissions) Session(session *gorm.Session) *roleHasManyRolePermissions {
	a.db = a.db.Session(session)
	return &a
}

func (a roleHasManyRolePermissions) Model(m *models.Role) *roleHasManyRolePermissionsTx {
	return &roleHasManyRolePermissionsTx{a.db.Model(m).Association(a.Name())}
}

func (a roleHasManyRolePermissions) Unscoped() *roleHasManyRolePermissions {
	a.db = a.db.Unscoped()
	return &a
}

type roleHasManyRolePermissionsTx struct{ tx *gorm.Association }

func (a roleHasManyRolePermissionsTx) Find() (result []*models.RolePermission, err error) {
	return result, a.tx.Find(&result)
}

func (a roleHasManyRolePermissionsTx) Append(values ...*models.RolePermission) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a roleHasManyRolePermissionsTx) Replace(values ...*models.RolePermission) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a roleHasManyRolePermissionsTx) Delete(values ...*models.RolePermission) (err error) {
	targetValues := make([]interface{}, len(values))
	for i, v := range values {
		targetValues[i] = v
	}
...
func (a roleHasManyRolePermissionsTx) Clear() error {
	return a.tx.Clear()
}

func (a roleHasManyRolePermissionsTx) Count() int64 {
	return a.tx.Count()
}

func (a roleHasManyRolePermissionsTx) Unscoped() *roleHasManyRolePermissionsTx {
	a.tx = a.tx.Unscoped()
	return &a
}
